...
Usage:
  python reverse-engineering/tools/scripts/hazel_packet_dump.py
  python reverse-engineering/tools/scripts/hazel_packet_dump.py --fan high
"""
...
sys.path.insert(0, str(re_root / "src"))
