...
async def probe_external_color(
    ...
    *,
    ...
    return _result_from_attempts(
        attempts,
        label="Color probe",
        empty_message="No probe candidates in reverse-engineering/tools/config/probe_candidates.yaml",
    )
...
async def probe_external_effect_static(
    ...
    *,
    ...
    return _result_from_attempts(
        ...
        empty_message="No effect probe candidates in reverse-engineering/tools/config/probe_candidates.yaml",
    )
...
async def probe_external_static_then_color(
    ...
    *,
    ...
    return _result_from_attempts(
        ...
        empty_message="No static-then-color candidates in reverse-engineering/tools/config/probe_candidates.yaml",
    )
...
async def probe_internal_light(
    ...
    *,
    ...
    return _result_from_attempts(
        ...
        empty_message="No internal_light candidates in reverse-engineering/tools/config/probe_candidates.yaml",
    )
...
async def probe_fan_speed(
    ...
    *,
    ...
    return _result_from_attempts(
        ...
        empty_message="No fan_speed candidates in reverse-engineering/tools/config/probe_candidates.yaml",
    )
