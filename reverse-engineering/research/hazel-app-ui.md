...
**Live APK:** `reverse-engineering/legacy/apk/com.razer.hazel.apk` — use the emulator setup script (no full Android Studio required).
...
adb wait-for-device && adb install -r reverse-engineering/legacy/apk/com.razer.hazel.apk
