...
Implemented: `set_internal_light()`, `reverse-engineering/tools/config/gatt_map.yaml`, `reverse-engineering/tools/config/probe_candidates.yaml` → `internal_light`.
...
| Try write variants | **[2] Advanced probes** or `reverse-engineering/tools/config/probe_candidates.yaml` |
