...
| Piece | Path |
|-------|------|
| Parsers | `src/zephyr_re/protocol/zephyr_parse.py` |
| Write builders | `src/zephyr_re/protocol/hazel_write.py` |
| Backend | `src/zephyr_re/protocol/razer_vendor.py` |
| State | `src/zephyr_re/device/state.py` |
| GATT templates | `config/gatt_map.yaml` |
