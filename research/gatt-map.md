...
3. Copy the vendor service UUID, write char, and notify char into `config/gatt_map.yaml`
...
Builders: `src/zephyr_re/protocol/hazel_write.py` · Templates: `config/gatt_map.yaml`
